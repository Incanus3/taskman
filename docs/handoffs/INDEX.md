...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Finish written reconciliation approval after consistency fixes, then plan implementation — `$resume ops-vps-readiness`
