...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Provisioning verified; remaining host acceptance awaits operator selection — `$resume ops-vps-readiness`
