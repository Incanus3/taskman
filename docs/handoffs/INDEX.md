...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Tasks 1–2 complete; continue from `tas-sr4b.3`, then separately authorize clean staging — `$resume ops-vps-readiness`
