...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Step 3: audit ops into a ranked candidate register and review improvements one by one before test overlap, squash and VPS acceptance — `$resume ops-vps-readiness`
