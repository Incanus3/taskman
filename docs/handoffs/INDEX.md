...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Tasks 1–9 are complete; recovery-aware cleanup is in progress in `tas-sr4b.10` — `$resume ops-vps-readiness`
