...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Step 3: exact failure design and plan approved; fresh-session execution next, candidates 4–8 pending — `$resume ops-vps-readiness`
