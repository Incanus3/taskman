...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Administrator/login/logout acceptance passed; reconciliation specification review and later canonical-doc updates remain — `$resume ops-vps-readiness`
