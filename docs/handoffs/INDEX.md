...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Decide the remaining load-bearing
  clean-source drift finding before any separately authorized staging or integration action —
