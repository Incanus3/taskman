...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Tasks 1–8 are complete; unfinished restore replacement is in progress in `tas-sr4b.9` — `$resume ops-vps-readiness`
