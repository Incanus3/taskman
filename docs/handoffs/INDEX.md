...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Final plan-review findings closed; implement from `tas-sr4b.1`, then separately authorize clean staging — `$resume ops-vps-readiness`
