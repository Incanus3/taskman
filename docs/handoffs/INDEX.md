...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Finish reconciliation specification review, then plan implementation and continue readiness — `$resume ops-vps-readiness`
