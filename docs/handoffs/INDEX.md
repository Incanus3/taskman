...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Tasks 1–10 and admission corrections are complete; resume remaining acceptance scenarios, builds, and documentation in `tas-sr4b.11` — `$resume ops-vps-readiness`
