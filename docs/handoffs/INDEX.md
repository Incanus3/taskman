...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Task 4 awaits independent review; then continue from `tas-sr4b.5` before separately authorizing clean staging — `$resume ops-vps-readiness`
