...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Tasks 1–8 are complete; continue with unfinished restore replacement in `tas-sr4b.9` — `$resume ops-vps-readiness`
