...
- [Operations VPS readiness](ops-vps-readiness.md) — active — Step 3: exact failure design approved; plan approval and candidates 4–8 pending before later gates — `$resume ops-vps-readiness`
