...
def _manifest(*, migrations: tuple[MigrationFingerprint, ...] = (MIGRATION,)) -> ArtifactManifest:
    return ArtifactManifest(
        SCHEMA_VERSION, APPLICATION, "0.2.0", CANDIDATE_REVISION, CANDIDATE,
...
def _request(
    ...
    *,
    ...
    return HostRequest(
        ...
        {
            "candidate_release_id": CANDIDATE, "artifact_sha256": checksum,
            "artifact_path": str(upload), "manifest": _manifest(migrations=migrations).to_mapping(),
