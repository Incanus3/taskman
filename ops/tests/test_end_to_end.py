...
from taskman_ops.provisioning import validate_existing_authority
...
def test_public_provision_executes_genesis_through_the_packaged_helper(
    ...
    capabilities = ProvisionCapabilities(
        ...
        target_resolution=lambda _remote, _config, _invocation, _clean_inputs: target,
    ...
    result = provision(
        Invocation(
            ...
            environment="production",
            yes=True,
            artifact=target.artifact.archive,
        ),
