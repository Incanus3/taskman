...
from .helper import discovery_request, merge_warnings, request as helper_request, result_error, run_request
...
def cleanup(
    ...
    *,
    ...
    try:
        ...
        warnings = merge_warnings(warnings, inspected.warnings)
