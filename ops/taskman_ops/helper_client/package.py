...
_FIXED_BACKUP_MAIN = b"from taskman_ops.host_helper.scheduled_backup import main\n\nraise SystemExit(main())\n"
...
ARCHIVE_MEMBERS = (
    ...
    "taskman_ops/checksums.py",
    "taskman_ops/errors.py",
    "taskman_ops/host_helper/__init__.py",
    "taskman_ops/host_helper/__main__.py",
    "taskman_ops/host_helper/backup_helper.py",
    "taskman_ops/host_helper/backup_protection.py",
    ...
    "taskman_ops/host_helper/operations/preflight.py",
    ...
    "taskman_ops/host_helper/restore_database.py",
    "taskman_ops/host_helper/restore_target.py",
...
_SOURCE_MEMBERS = {
    "taskman_ops/migrations.py": _SOURCE_ROOT / "migrations.py",
    "taskman_ops/checksums.py": _SOURCE_ROOT / "checksums.py",
    "taskman_ops/errors.py": _SOURCE_ROOT / "errors.py",
    "taskman_ops/host_helper/__init__.py": _SOURCE_ROOT / "host_helper" / "__init__.py",
    "taskman_ops/host_helper/backup_protection.py": _SOURCE_ROOT / "host_helper" / "backup_protection.py",
    "taskman_ops/host_helper/backup_helper.py": _SOURCE_ROOT / "host_helper" / "backup_helper.py",
    ...
    "taskman_ops/host_helper/operations/preflight.py": _SOURCE_ROOT / "host_helper" / "operations" / "preflight.py",
    ...
    "taskman_ops/host_helper/restore_database.py": _SOURCE_ROOT / "host_helper" / "restore_database.py",
    "taskman_ops/host_helper/restore_target.py": _SOURCE_ROOT / "host_helper" / "restore_target.py",
