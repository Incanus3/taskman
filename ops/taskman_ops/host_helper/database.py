...
def _initial_database_empty(database: Mapping[str, object], credentials: Path | None) -> bytes:
    ...
    return _database_query(
        ...
        "WITH user_namespaces AS ("
            ...
            "UNION ALL SELECT 1 FROM pg_catalog.pg_collation catalog_collation "
            "WHERE catalog_collation.collnamespace IN (SELECT oid FROM user_namespaces) "
            "OR catalog_collation.collnamespace = 'public'::pg_catalog.regnamespace "
            ...
            "UNION ALL SELECT 1 FROM pg_catalog.pg_user_mappings "
