defmodule TaskmanWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TaskmanWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TaskmanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TaskmanWeb.Gettext, "errors", msg, opts)
    end
  end
